...
// # Constructor
THREE.DomEvent = function(camera, domElement)
{
...
// # Destructor
THREE.DomEvent.prototype.destroy = function()
{
...
THREE.DomEvent.prototype._objectCtxInit = function(object3d){
    object3d._3xDomEvent = {};
}
THREE.DomEvent.prototype._objectCtxDeinit = function(object3d){
    delete object3d._3xDomEvent;
}
THREE.DomEvent.prototype._objectCtxIsInit = function(object3d){
    return object3d._3xDomEvent ? true : false;
}
THREE.DomEvent.prototype._objectCtxGet = function(object3d){
...
*/
THREE.DomEvent.prototype.camera = function(value)
{
    if( value ) this._camera = value;
    return this._camera;
}

THREE.DomEvent.prototype.bind = function(object3d, eventName, callback, useCapture)
{
    console.assert( THREE.DomEvent.eventNames.indexOf(eventName) !== -1, "not available events:"+eventName );
...
THREE.DomEvent.prototype.unbind = function(object3d, eventName, callback)
{
    console.assert( THREE.DomEvent.eventNames.indexOf(eventName) !== -1, "not available events:"+eventName );
...
THREE.DomEvent.prototype._bound = function(eventName, object3d)
{
    var objectCtx = this._objectCtxGet(object3d);
...
THREE.DomEvent.prototype._onMove = function(mouseX, mouseY, origDomEvent)
{
...
THREE.DomEvent.prototype._onEvent = function(eventName, mouseX, mouseY, origDomEvent)
{
    var vector = new THREE.Vector3( mouseX, mouseY, 1 );
    this._projector.unprojectVector( vector, this._camera );
...
THREE.DomEvent.prototype._notify = function(eventName, object3d, origDomEvent)
{
    var objectCtx = this._objectCtxGet(object3d);
...
THREE.DomEvent.prototype._onMouseDown = function(event){
    return this._onMouseEvent('mousedown', event);
}
THREE.DomEvent.prototype._onMouseUp = function(event){
    return this._onMouseEvent('mouseup' , event);
}


THREE.DomEvent.prototype._onMouseEvent = function(eventName, domEvent)
{
    var size = Panoviewer.getDimension(domEvent.target);
    var mouseX = +( (domEvent.clientX - domEvent.target.offsetLeft)/ size.w ) * 2 - 1;
    var mouseY = -( (domEvent.clientY - domEvent.target.offsetTop )/ size.h ) * 2 + 1;
    return this._onEvent(eventName, mouseX, mouseY, domEvent);
}

THREE.DomEvent.prototype._onMouseMove = function(domEvent)
{
    var size = Panoviewer.getDimension(domEvent.target);
    var mouseX = +( (domEvent.clientX - domEvent.target.offsetLeft)/ size.w ) * 2 - 1;
    var mouseY = -( (domEvent.clientY - domEvent.target.offsetTop )/ size.h ) * 2 + 1;
...
THREE.DomEvent.prototype._onClick = function(event)
{
    // TODO handle touch ?
    return this._onMouseEvent('click' , event);
}
THREE.DomEvent.prototype._onDblClick = function(event)
{
    // TODO handle touch ?
...
THREE.DomEvent.prototype._onTouchStart = function(event){
    return this._onTouchEvent('mousedown', event);
}
THREE.DomEvent.prototype._onTouchEnd = function(event){
    return this._onTouchEvent('mouseup' , event);
}

THREE.DomEvent.prototype._onTouchMove = function(domEvent)
{
...
THREE.DomEvent.prototype._onTouchEvent = function(eventName, domEvent)
{
    if( domEvent.touches.length != 1 ) return undefined;
